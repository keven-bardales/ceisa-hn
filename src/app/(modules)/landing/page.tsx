...
import { Eye, Facebook, Goal, Home, Instagram, Lightbulb, LocateIcon, Mail, Menu, PackageSearch, Sun, TrendingUp, Zap } from "lucide-react";
  ...
  return (
    <>
      <main className="bg-white w-full h-screen overflow-auto relative">
              ...
              {LANDINGPRODUCTS.map((product, index) => (
                <div key={index} className="flex flex-col items-center gap-y-3 border border-black p-3">
                  <Image
                    ...
                    className={cn(
                      "w-full max-w-[55%] sm:max-w-[70%] h-[200px] mx-auto sm:h-[260px] lg:h-[260px]",
        ...
        <section className={cn("!pt-[6rem] !pb-[5rem] bg-landing-second-bg px-4 relative", mainSectionPadding)}>
          <div className="container mx-auto flex flex-col gap-y-6">
            ...
            <p className="text-center text-2xl font-semibold text-landing-text-primary max-w-[90%] lg:max-w-[60%] mx-auto">
              ...
              para proyectos residenciales, comerciales o industriales, tenemos todo lo necesario para que sus instalaciones sean seguras y
              eficientes.
            </p>
          </div>
        </section>
          ...
          <div className="container mx-auto grid lg:grid-cols-3 gap-5 gap-y-8 gap-x-6">
            <div className="p-8 rounded-xl grow flex flex-col gap-y-4 items-center bg-landing-first-bg shadow-xl">
              ...
              <p className="text-center text-2xl font-medium text-landing-text-primary mx-auto leading-relaxed tracking-wide">
                Nuestra misión es proporcionar materiales de alta calidad que garanticen la seguridad y eficiencia de las instalaciones eléctricas.
                Nos comprometemos a ofrecer un servicio excepcional y soluciones personalizadas para nuestros clientes.
              </p>
            </div>
            ...
            <div className="p-8 rounded-xl grow flex flex-col gap-y-4 bg-landing-first-bg items-center shadow-xl">
              ...
              <p className="text-center text-2xl font-medium text-landing-text-primary mx-auto leading-relaxed tracking-wide">
                Ser la empresa líder en el mercado de materiales eléctricos, reconocida por nuestra excelencia en servicio y compromiso. Aspiramos a
                ser el socio preferido de nuestros clientes y contribuir al desarrollo de infraestructuras eléctricas eficientes.
              </p>
            </div>
          </div>
        </section>
        <section id="contact" className={cn("!pt-[6rem] scroll-mt-12 px-4 !pb-[5rem] bg-landing-first-bg relative", mainSectionPadding)}>
          <div className="flex gap-x-4 items-center container mx-auto">
            <div className="flex flex-col gap-y-2 text-left">
              ...
              <div className="flex items-center lg:flex-row flex-col justify-center">
                ...
                <div className="flex flex-col gap-y-3 shadow-2xl mx-auto bg-landing-second-bg p-5 rounded-lg">
        ...
        <footer className="bg-black font-xl shadow h-fit">
          <div className="w-full mx-auto p-4 md:px-20 md:flex md:flex-row text-center md:text-left md:items-center md:justify-between">
            <span className="text-white sm:text-center text-base">
              © 2024{" "}
              <Link href="/landing/#home" className="hover:underline">
                Ceisa Honduras™{" "}
              </Link>
              <span className="text-base text-white">Todos los derechos reservados.</span>
            </span>
            <ul className="grid grid-cols-2 mt-4 md:mt-0 md:grid-cols-4 gap-4 text-base">
              {landingNavBarItems.map((item) => {
                return (
                  <Link className="text-white text-base" href={item.href} key={item.content}>
                    {item.content}
                  </Link>
                );
              })}
